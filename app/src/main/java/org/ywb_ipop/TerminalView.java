...
import org.ywb_ipop.service.FontSizeChangedListener;
...
public class TerminalView extends View implements FontSizeChangedListener {
	...
	public TerminalView(Context context, TerminalBridge bridge1) {
		super(context);
		...
		cursorPaint.setColor(bridge1.color[bridge1.defaultFg]);
		cursorPaint.setXfermode(new PixelXorXfermode(bridge1.color[bridge1.defaultBg]));
		...
		bridge1.addFontSizeChangedListener(this);

		// connect our view up to the bridge
		setOnKeyListener(bridge1.getKeyHandler());
