 ...
 * @author jsharkey
 */
public class TerminalManager extends Service implements BridgeDisconnectedListener, BridgeSendOverListener,OnSharedPreferenceChangeListener {
    ...
    public Handler sendoverHandler = null;
	...
	private TerminalBridge openConnection(HostBean host) throws IllegalArgumentException, IOException {
        ...
        bridge.setOnSendOveredListener(this);
    ...
    public void onSendOvered(TerminalBridge bridge) {
        if(sendoverHandler!=null)
            Message.obtain(sendoverHandler, -1, bridge).sendToTarget();
    }
	/**
